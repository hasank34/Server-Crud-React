...
const [isOpen, setIsOpen] =  useState(false);
  ...
  return (
    <li className="p-3 list-group-item d-flex justify-content-between align-content-center gap-3">
        {icon}
      ...
      {isOpen && <Modal todo={todo} close = {() => setIsOpen(false)} setTodos= {setTodos} />}
    </li>
  );
};
